...
type UserFile struct {
	...
	StorageDriver  string `json:"-" gorm:"size:16;index;uniqueIndex:idx_user_file_driver_object"`
	ObjectKey      string `json:"-" gorm:"size:512;uniqueIndex:idx_user_file_driver_object"`
...
type UserFileUploadReservation struct {
	...
	StorageDriver        string `json:"-" gorm:"size:16;index;uniqueIndex:idx_user_upload_driver_object"`
	ObjectKey            string `json:"objectKey" gorm:"size:512;uniqueIndex:idx_user_upload_driver_object"`
	MimeType             string `json:"mimeType"`
	Size                 int64  `json:"size"`
...
type UserObjectDeletion struct {
	...
	StorageDriver  string `json:"-" gorm:"size:16;index;uniqueIndex:idx_user_deletion_driver_object"`
	ObjectKey      string `json:"objectKey" gorm:"size:512;uniqueIndex:idx_user_deletion_driver_object"`
	Size           int64  `json:"-"`
