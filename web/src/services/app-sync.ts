...
async function readDomainManifest<T>(config: WebdavSyncConfig, domain: AppSyncDomainKey, emptyData: T): Promise<DomainManifest<T> | null> {
...
function domainLabel(domain: AppSyncDomainKey) {
