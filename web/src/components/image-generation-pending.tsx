...
export function ImageGenerationPending({ className, label, compact = false }: { className?: string; label?: string; compact?: boolean }) {
    ...
    return (
        <div className={cn("relative overflow-hidden bg-neutral-100 dark:bg-surface-2", compact ? "min-h-24" : "aspect-[4/3]", className)}>
            <div
            ...
            />
            <div className="absolute left-4 top-4 flex items-center gap-2 text-[15px] font-medium text-neutral-500 dark:text-neutral-300">
            ...
            <div className="absolute bottom-4 left-4 right-4">
                ...
                <div className="h-1.5 rounded-full bg-neutral-300/70 dark:bg-white/12">
                    <div className="h-full rounded-full bg-neutral-900 dark:bg-neutral-100" style={{ width: `${progress}%` }} />
                </div>
            </div>
        </div>
    );
