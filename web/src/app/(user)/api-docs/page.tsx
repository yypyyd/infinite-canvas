                ...
                <div className="relative mt-8 grid items-start gap-4 lg:grid-cols-[250px_minmax(0,1fr)]">
                    ...
                    <section className="min-w-0">
                        ...
                        {isLoading || !modelChannel ? (
                            ...
                            <div className="rounded-xl border border-dashed border-border bg-card py-20">
    ...
    return (
        <div className="pb-6">
            <div className="flex items-start gap-4 border-b border-border pb-6 pr-8">
                <span className="flex size-12 shrink-0 items-center justify-center rounded-lg bg-primary/10 text-primary ring-1 ring-primary/15">
