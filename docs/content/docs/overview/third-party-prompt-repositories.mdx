...
| 地址 | 状态 |
| --- | --- |
| https://github.com/freestylefly/awesome-gpt-image-2 | 作为 GPT Image 2 分类的数据源（517 个案例） |
| https://github.com/ZeroLu/awesome-seedance | 已实现同步逻辑（Seedance 视频提示词） |
| https://github.com/EvoLinkAI/awesome-gpt-image-2-API-and-Prompts | 原仓库已失效，GPT Image 2 分类改用 Freestyle 源 |
...
| https://github.com/wuyoscar/GPT-Image2-Skill | 已实现 Gallery 同步逻辑（162 个 GPT Image 2 分类案例，MIT） |
