    ...
    return (
        <Flex vertical gap={16}>
            ...
            <Card
                ...
                extra={
                    <Form.Item name={["public", "announcements", "enabled"]} noStyle valuePropName="checked">
                ...
                <Form.List name={["public", "announcements", "items"]}>
                    {(fields, { add, remove }) => (
                        <Flex vertical gap={12}>
                            {fields.length ? (
                                fields.map((field, index) => (
                                    <Card
                                        ...
                                        title={
                                            <Space>
                                                <Tag color={announcementTypes[index % announcementTypes.length].color}>公告 {index + 1}</Tag>
                                    ...
                                    >
                                        ...
                                        <Row gutter={12}>
                                            ...
                                            <Col xs={24} md={6}>
                                                <Form.Item name={[field.name, "publishAt"]} label="发布时间" getValueProps={(value) => ({ value: value ? dayjs(value) : null })} normalize={(value) => value?.toISOString() || ""}>
                            ...
                            <Button type="dashed" block onClick={() => add({ id: Date.now(), title: "", content: "", type: "info", publishAt: new Date().toISOString(), enabled: true })}>
                                添加公告
                            </Button>
                        </Flex>
                    )}
    ...
    return (
        <Flex vertical gap={16}>
            ...
            <Card
                ...
                title="积压阈值"
                extra={
                    <Form.Item name={["private", "operationsAlerts", "enabled"]} noStyle valuePropName="checked">
                        <Switch checkedChildren="已开启" unCheckedChildren="已关闭" />
                    </Form.Item>
                }
            >
    ...
    return (
        <Flex vertical gap={16}>
            ...
            >
                ...
                <Form.Item name={["public", "auth", "emailVerification"]} hidden valuePropName="checked">
                    <Switch />
                </Form.Item>
            </Card>
        </Flex>
