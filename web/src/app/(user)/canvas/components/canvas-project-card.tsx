...
export function CanvasProjectCard({ project }: { project: CanvasProject }) {
    ...
    return (
        <article className="group flex min-h-44 cursor-pointer flex-col justify-between rounded-2xl bg-[#f1eee8] p-5 transition hover:bg-[#ebe6dc] dark:bg-card dark:ring-1 dark:ring-border dark:hover:bg-surface-2 dark:hover:ring-border-strong" onClick={() => !editing && open()}>
