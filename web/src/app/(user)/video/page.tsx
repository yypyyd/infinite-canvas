...
export default function VideoPage() {
    ...
    const deleteSelectedLogs = () => {
        void Promise.all(selectedLogIds.map((id) => deleteStoredGenerationRecord(historyOwnerId, "video", id))).then(refreshLogs);
